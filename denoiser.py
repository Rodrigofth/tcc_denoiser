...
def Get_Audio():
  #baixa_arq('audios')
  nome_audios = []
  nome_audios = os.listdir("/base/rodrigo@fleith@pantanal/downloads/DataSet_Audio")
  dataset_voice = []
  new_string = "/base/rodrigo@fleith@pantanal/downloads/DataSet_Audio/"
  n = 1
...
def Get_Noise():
  #baixa_arq('ruidos')
  nome_ruidos = []
  nome_ruidos = os.listdir("/base/rodrigo@fleith@pantanal/downloads/DataSet_Ruido")
  dataset_noise = []
  new_string = "/base/rodrigo@fleith@pantanal/downloads/DataSet_Ruido/"
