...
#Mascara Binaria Ideal
  ...
  Ajustaressaporra = librosa.amplitude_to_db(np.abs(specVoice),ref=np.max)
  Mask_spec = []

  return Voice, NoiseSegment, specVoice, specNoise, specMix, SNR_Mix

v, n, spV, spN, spM, SNR = Get_Features()